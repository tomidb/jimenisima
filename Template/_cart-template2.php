          ...
          <div class="row">
              <div class="col-sm-9">
                  <?php
                      ...
                      // Obtener los productos del carrito del usuario actual utilizando el método de la clase Cart
                      $userCartItems = $Cart->getUserCartItems($user_id);

                      // Verificar si se encontraron productos asociados al usuario
                  ...
                  <?php
                          ...
                          }, $userCartItems); // closing array_map function
                          }
                      } else {
                          // Si no se encontraron productos asociados al usuario, mostrar un mensaje de que el carrito está vacío
